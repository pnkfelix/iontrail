...
TypedObjectPointer.prototype.getReference = function() {
  ...
  case JS_REFERENCETYPEREPR_ANY:
    return Load_Any(this.typedDatum, this.offset);

  case JS_REFERENCETYPEREPR_OBJECT:
    return Load_Object(this.typedDatum, this.offset);

  case JS_REFERENCETYPEREPR_STRING:
    return Load_string(this.typedDatum, this.offset);
  }
...
TypedObjectPointer.prototype.setReference = function(fromValue) {
  ...
  switch (type) {
  case JS_REFERENCETYPEREPR_ANY:
    return Store_Any(this.typedDatum, this.offset, fromValue);

  case JS_REFERENCETYPEREPR_OBJECT:
    var value = (fromValue === null ? fromValue : ToObject(fromValue));
    return Store_Object(this.typedDatum, this.offset, value);

  case JS_REFERENCETYPEREPR_STRING:
    return Store_string(this.typedDatum, this.offset, ToString(fromValue));
  }
